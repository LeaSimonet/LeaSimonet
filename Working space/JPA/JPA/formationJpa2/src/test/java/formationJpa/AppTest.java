...
import formationJpa.repositories.DaoClient2;
...
public class AppTest {
	public static void main(String[] args) {
		...
		DaoClient2 daoClient2 =JpaContext.getDaoClient2();
		...
		Client2 olivier=new Client2( "gozlan", new Adresse("11", "rue aaa", "11111", "paris"), "olivier");
		daoClient2.insert(olivier);
		
		Client2 clientEnBase=daoClient2.findByKey(olivier.getId());
