...
@AttributeOverride(name="adresse.numero", column=@Column(name="supplier_num", length=50))
@AttributeOverride(name="adresse.rue", column=@Column(name="supplier_street"))
@AttributeOverride(name="adresse.codePostal", column=@Column(name="supplier_zip", length=50))
@AttributeOverride(name="adresse.city", column=@Column(name="supplier_city"))
