...
public class ProduitController extends HttpServlet {
	...
	private Produit getProduit(HttpServletRequest request) {
		...
		Long fournisseurId = Long.parseLong(request.getParameter("fournisseur.id")); 
	    Fournisseur fournisseur = fournisseurSrv.getById(fournisseurId); 
	...
	private RequestDispatcher goForm(HttpServletRequest request, HttpServletResponse response) {
	    request.setAttribute("produit", new Produit());
	    request.setAttribute("action", "create");
	    request.setAttribute("fournisseurs", getAllFournisseurs()); // ajoutez cette ligne
	    request.setAttribute("produits", getAllProduits()); // ajoutez cette ligne
